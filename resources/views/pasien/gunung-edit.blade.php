...
<main class="app-content">
    ...
    <div class="row">
        <div class="col-md-12">
			<div class="tile">
			  <div class="tile-body">
				<form class="form-horizontal" id="submit-form" enctype="multipart/form-data" method="post" action="{{route('admin.gunung.update')}}"> @method('put')
                {{ csrf_field() }} <input type="hidden" name="id" value="{{$gunung->id}}">
                    <div class="row">
                        <div class="col-md-9 col-sm-12">
                            <div class="form-group row">
                                <label for="nama" class="col-sm-2 col-form-label">Nama Gunung</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama" id="staticEmail" placeholder="Nama Gunung" value="{{$gunung->nama}}">
                                    @if ($errors->has('nama'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="alamat" id="staticEmail" placeholder="Alamat Gunung" value="{{$gunung->alamat}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select name="status" class="form-control" id="status">
                                        ...
                                        <option {{$gunung->status='Aktif Normal'? 'selected': ''}}>Aktif Normal</option>
                                        <option {{$gunung->status='Waspada'? 'selected': ''}}>Waspada</option>
                                        <option {{$gunung->status='Siaga'? 'selected': ''}}>Siaga</option>
                                        <option {{$gunung->status='Awas'? 'selected': ''}}>Awas</option>
                                        <option {{$gunung->status='Non Aktif'? 'selected': ''}}>Non Aktif</option>
                                    </select>
                        ...
                        <div class="col-sm-12 col-md-3">
                            <img src="{{$gunung->thumbnail}}" width="100%" class="rounded" alt="thumbnail" id="thumbnail">
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-sm-12">
                        <textarea id="summernote" name="deskripsi">{{$gunung->deskripsi}}</textarea>
                    </div>
                    </div>
