...
<html>
  ...
  <body>
    ...
    <div class="cover" style="background-color: {{env('COLOR_DOKTER')}}"></div>
    </section>
    <section class="login-content">
      <div class="login-box" style="min-height: 420px;">
        ...
        <div class="form-group text-center">
          Anda Telah Masuk Sebagai dokter, Silahkan Klik dibawah ini untuk menuju beranda dokter
            <br><br>
            <a href="{{url('dokter')}}" class="btn btn-primary">Beranda dokter</a>
            <br><br>
        atau
        <br><br>
        ...
        @else
        <form class="login-form" method="post" action="{{route('dokter.login')}}">
          @csrf
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>Login Dokter</h3>
