...
<main class="app-content">
    ...
    <div class="row">
        <div class="col-md-12">
			<div class="tile">
			  <div class="tile-body">
				<form class="form-horizontal" id="submit-form" method="post" action="{{route('dokter.alatterpasang.store')}}">
                    {{ csrf_field() }} 
                        ...
                        <div class="col-md-4 col-sm-12">
                            ...
                            <table class="table table-sm table-bordered">
                                ...
                                @foreach ($periksa->alatterpasang()->get() as $alatterpasang)
                                    <tr>
                                        <td><b>{{$alatterpasang->inventaris->jenis}} {{$alatterpasang->inventaris->ukuran}} </b><br>
                                            {{$alatterpasang->lokasi}}</td>
                ...
                <div class="col-md-8">
				  ...
				  <div class="col-md-4">
                    <div class="float-right">
                        ...
                        <a class="btn btn-secondary" href="{{route('dokter.periksa.show',['id'=>$periksa->id])}}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Batal</a>
                    </div>
				</div>
                </div>
			  </div>
...
<script>
    function status(no) {
        $.get('{{ route('dokter.alatterpasang.status')}}?id='+no, function(response){
