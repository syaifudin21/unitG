...
<html>
  ...
  <body>
    ...
    <div class="cover" style="background-color: {{env('COLOR_PEGAWAI')}}"></div>
    </section>
    <section class="login-content">
      <div class="login-box" style="min-height: 420px;">
        ...
        <div class="form-group text-center">
          Anda Telah Masuk Sebagai Pegawai, Silahkan Klik dibawah ini untuk menuju beranda pegawai
            <br><br>
            <a href="{{url('pegawai')}}" class="btn btn-primary">Beranda Pegawai</a>
            <br><br>
        atau
        <br><br>
        ...
        @else
        <form class="login-form" method="post" action="{{route('pegawai.login')}}">
          @csrf
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>Login Pegawai</h3>
