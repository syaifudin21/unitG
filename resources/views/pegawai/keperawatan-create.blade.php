...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1>Tindakan Keperawatan</h1>
            <p>Menambahkan tindakan keperawatan pada pasien</p>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
			<div class="tile">
			  <div class="tile-body">
				<form class="form-horizontal" id="submit-form" method="post" action="{{route('pegawai.keperawatan.store')}}">
                    {{ csrf_field() }} 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-12">
                                ...
                                <hr>
                                    <textarea class="form-control" name="tindakan" id="tindakan" rows="15" placeholder="Tindakan Keperawatan">{{old('tindakan')}}</textarea>
                                    @if ($errors->has('tindakan'))
                                        <small class="form-text text-muted">{{ $errors->first('tindakan') }}</small>
                                    @endif
                            </div>
                        </div>
                    </div>
